...
export default class Charts extends PureComponent {
  ...
  handleStartDateChange = (date) => {
    ...
    this.props.history.push(
      `/charts?name=${this.state.charts}&startdate=${startdate1}&enddate=${enddate1}`
    );
  };
  handleEndDateChange = (date) => {
    ...
    this.props.history.push(
      `/charts?name=${this.state.charts}&startdate=${startdate2}&enddate=${enddate2}`
    );
  };
  ...
  handleChartsChange = (event) => {
    ...
    this.props.history.push(
      `/charts?name=${event.target.value}&startdate=${sdate}&enddate=${edate}`
    );
  };
  ...
  render() {
    ...
    const data = [
      {
        name: moment(this.state.selectedDate).format("DD-MM-YYYY"),
        pv: 2400,
        amt: 2400,
      },
      {
        name: moment("2020-3-10").format("DD-MM-YYYY"),
        pv: 1398,
        amt: 2210,
      },
      {
        name: moment("2020-3-12").format("DD-MM-YYYY"),
        pv: 12000,
        amt: 2290,
      },
      {
        name: moment("2020-3-15").format("DD-MM-YYYY"),
        pv: 3908,
        amt: 2000,
      },
      {
        name: moment("2020-3-17").format("DD-MM-YYYY"),
        pv: 4800,
        amt: 2181,
      },
      {
        name: moment("2020-3-19").format("DD-MM-YYYY"),
        pv: 3800,
        amt: 2281,
      },

      {
        name: moment(this.state.selectedDate1).format("DD-MM-YYYY"),
        pv: 4300,
        amt: 2100,
      },
    ];
